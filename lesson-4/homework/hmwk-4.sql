...
SELECT FIRSTNAME, LASTNAME,
	ISNULL (EMAIL, 'noemail@example.com' ) AS EMAIL_INFO 
	FROM Employees;
...
SELECT COALESCE (FIRSTNAME, LASTNAME, 'NULL') AS NON_NULL
	FROM Employees
...
-- 16. Write a query to display all products with Price <= 1000 and StockQuantity > 50, 
